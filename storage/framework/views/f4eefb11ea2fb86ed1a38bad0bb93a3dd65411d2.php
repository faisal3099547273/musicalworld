...
<head>
    ...
    <meta charset="utf-8" />
    <title><?php echo app('translator')->get('Music World'); ?></title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                ...
                <div class="my-2 ms-lg-2">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-success w-xs">Sign in</a>
                </div>
            </div>
        </div>
    </nav>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <p class="text-muted"><?php echo app('translator')->get('Companies'); ?></p>
                                        <h5><?php echo e($total_companies); ?></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center mb-5">
                        ...
                        <h4><?php echo app('translator')->get('About Us The Musical World'); ?></h4>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
